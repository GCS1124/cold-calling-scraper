...
export const freeAiModePolicy =
  'Free AI mode does not use paid databases, including commercial lead databases, private profiles, login sessions, paywall bypasses, or contact-reveal credits. Gemini may expand public search lenses and return grounded public research candidates when configured; every candidate is retained for review, while independently validated public phone evidence is required for export. Gemini usage remains subject to that provider account\'s limits or charges.';
