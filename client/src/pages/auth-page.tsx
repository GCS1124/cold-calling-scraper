...
export function AuthPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-50 px-4 py-6 text-slate-950 sm:px-6 lg:px-8">
      ...
      <section className="relative mx-auto grid min-h-[calc(50vh-3rem)] h-full w-full max-w-6xl overflow-hidden rounded-[2rem] border border-white/70 bg-white/80 shadow-[0_30px_100px_rgba(15,23,42,0.14)] backdrop-blur-xl lg:grid-cols-[1.05fr_0.95fr]">
